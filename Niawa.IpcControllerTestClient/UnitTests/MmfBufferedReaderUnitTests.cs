...
{
    public class MmfBufferedReaderUnitTests
    {
        ...
        [Test]
        public void Test_NIC_MBR_StartListening()
        {
        ...
        [Test]
        public void Test_NIC_MBR_GetNextMessageFromBuffer()
        {
            string TEST_IPC_TYPE = "TEST_IPC_TYPE_" + Guid.NewGuid().ToString();
        ...
        [Test]
        public void Test_NIC_MBR_Prop_IpcType()
        {
            string TEST_IPC_TYPE = "TEST_IPC_TYPE_" + Guid.NewGuid().ToString();
